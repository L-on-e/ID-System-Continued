...
#id::before {
  ...
  width: 100%;
  height: 100%;
  background: url('images/bg1.png');   /*if you want to change the background image replace logo.png*/
    ...
    window.close()
     ...
     $idx = $_GET['id'];
      $sqlmember ="SELECT * FROM Users WHERE id='$idx' ";
			       $retrieve = mysqli_query($db,$sqlmember);
                     ...
                     while($found = mysqli_fetch_array($retrieve))
	                 {
             	 	...
             	 	if($profile!=""){          
										   echo"<img src='images/$profile' height='150px' width='160px' alt='' style='border: 2px solid black;'>";	   
									    }
								else{
	  ...
	  <p style="margin-top:-4%">&nbsp;</p>
      	<p style="font-weight: bold;margin-top:-3%;font-size:27px;"><?php if(isset($names)){ $namez=$title.' '.$names;echo$namez;} ?></p>
      	<p style="margin-top:-4%">&nbsp;</p>
      	<p style="margin-top:-4%">&nbsp;</p>
       <p style="margin-top:-4%">&nbsp;</p>
        <p style="font-weight: bold;margin-top:-4%;font-size:14px;">ID NO:<?php if(isset($pass)){ echo$pass;} ?></p>
      	<p style="font-weight: bold;margin-top:-3%"><?php if(isset($rank)){ echo$rank;} ?></p>
		  <p style="font-weight: bold;margin-top:-3%"><?php if(isset($rank)){ echo$rank;} ?></p>
      	</center>
            ...
            <div class="id-1">
					...
					<hr align="center" style="border: 1px solid black;width:90%;margin-top:12%"></hr> 
