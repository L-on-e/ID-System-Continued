        ...
        <center>
          ...
          <form method="post" action="upload.php" enctype='multipart/form-data'>
            ...
            <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;First Name:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="firstName" id="firstname"></span></p>
                        ...
                        <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;&nbsp; &nbsp;Contract Duration(start)<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="contractDuration_start" id="contractduration_start"></span></p>
                        <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;&nbsp; &nbsp;Contract Duration (end)<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="contractDuration_end" id="contractduration_end"></span></p>
                        <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;&nbsp; &nbsp;Inclusive Date of Employment:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="inclusiveDateOfEmployment" id="inclusivedateofemployment"></span></p>
                        ...
                        <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;&nbsp; &nbsp;Birthdate:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="birthdate" id="birthdate"></span></p>
