	...
	while($foundk = mysqli_fetch_array($retrieve))
      ...
      $sqlmember ="SELECT * FROM Users WHERE id>=$from && id<=$to";
			       $retrieve = mysqli_query($db,$sqlmember);
	                 ...
	                 {
                       $title=$found['Mtitle'];$firstname=$found['Firstname'];$sirname=$found['Sirname'];$rank=$found['Ranks'];
        ...
        <?php   
      	...
      	<p style="margin-top:-4%">&nbsp;</p>
       <p style="margin-top:-4%">&nbsp;</p>
        <p style="font-weight: bold;margin-top:-11%;font-size:14px;">ID NO:<?php if(isset($pass)){ echo$pass;} ?></p>
