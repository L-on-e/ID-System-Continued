		...
		<div class="id-1">
			<div id="id">
				...
				?> <div class="container" align="center">
					...
					<span style="position: absolute; left: 45%;right: 2%;top: 93.8%; font-size:11px; font-family: 'Lora';  line-height: 0.8;"><?php if (isset($position)) {
																																					echo $position;
																																				} ?></span>
					<p style="margin-top:20%">&nbsp;</p>
					<div style="margin-left: 40%; margin-top:30px; font-size:18px; font-family: 'Lora'; text-align:center; line-height: 0.8;">
					...
					<p style="position: absolute; top: 0; margin-left:172px; margin-top:108%; font-size:14px; font-family: 'Lora';">ID NO. <?php if (isset($id)) {
																																				echo $id;
																																			} ?></p>
