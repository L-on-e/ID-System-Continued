...
<body>
    <script type="text/javascript">
        // Set the print options for the current document
        var printOptions = {
            printMethod: function() {
                // Open the Print dialog box
                window.print();

                // Wait for the user to select the Save as PDF option
                setTimeout(function() {
        ...
        // Call the printMethod to print the document and save as PDF
        printOptions.printMethod();
    </script>
